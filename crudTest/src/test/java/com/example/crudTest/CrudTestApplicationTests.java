...
class StudentControllerTest {
	...
	void updateStudent() throws Exception {
		...
		MvcResult resultOne = this.mockMvc.perform(put("/student/setStudent/" + student.getId())
						.contentType(MediaType.APPLICATION_JSON)
						.content(userJSON))
				.andDo(print())
				.andExpect(status().isOk())
	...
	void deleteStudent() throws Exception {
		...
		this.mockMvc.perform(delete("/student/deleteById/" + student.getId()))
				.andDo(print())
				.andExpect(status().isOk())
				.andReturn();
	...
	void workingStudent() throws Exception {
		...
		MvcResult result = this.mockMvc.perform(put("/student/setWorking/" + student.getId() + "?working=true"))
				.andDo(print())
				.andExpect(status().isOk())
				.andReturn();
